      ...
      <div className="md:hidden fixed bottom-0 left-0 z-50 w-full h-16 bg-background border-t">
        <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
          <Link to="/" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            <Home className="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-[#e91e63]" />
            <span className="text-xs text-gray-500 dark:text-gray-400 group-hover:text-[#e91e63]">Home</span>
          </Link>
          <Link to="/categories" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            <LayoutGrid className="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-[#e91e63]" />
            <span className="text-xs text-gray-500 dark:text-gray-400 group-hover:text-[#e91e63]">Categories</span>
          </Link>
          <Link to="/cart" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            <ShoppingCart className="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-[#e91e63]" />
            <span className="text-xs text-gray-500 dark:text-gray-400 group-hover:text-[#e91e63]">Cart</span>
          </Link>
          <Link to="/login" className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            <User className="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-[#e91e63]" />
            <span className="text-xs text-gray-500 dark:text-gray-400 group-hover:text-[#e91e63]">Account</span>
          </Link>
        </div>
      </div>
    </>
